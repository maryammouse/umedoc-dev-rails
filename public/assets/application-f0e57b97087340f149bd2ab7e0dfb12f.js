...
(function() {
  var authy_form_helpers;

  authy_form_helpers = (function() {
    ...
    window.Authy.UI = function() {
      ...
      absolutePosFor = void 0;
      buildItem = void 0;
      countriesList = void 0;
      disableAutocompleteAuthyToken = void 0;
      findAndSetupCountries = void 0;
      getKeyCode = void 0;
      hideAutocompleteList = void 0;
      processKey13 = void 0;
      processKey38 = void 0;
      processKey40 = void 0;
      self = void 0;
      setActive = void 0;
      setCountryField = void 0;
      setupAuthyTokenValidation = void 0;
      setupCellphoneValidation = void 0;
      setupCountriesDropdown = void 0;
      setupCountriesDropdownPosition = void 0;
      setupEvents = void 0;
      setupTooltip = void 0;
      setupTooltipPosition = void 0;
      ...
      setupCellphoneValidation = function() {
        ...
        return cellPhone.onblur = function() {
      ...
      disableAutocompleteAuthyToken = function() {
        ...
        return token.setAttribute("autocomplete", "off");
      };
      setupTooltip = function() {
        ...
        return setupTooltipPosition(authy_help, tooltip);
      };
      ...
      processKey40 = function(listId) {
        var _i, _len, activeElement, caId, countriesArr, countriesDropdown, i, li;
        activeElement = void 0;
        caId = void 0;
        countriesArr = void 0;
        countriesDropdown = void 0;
        i = void 0;
        li = void 0;
        _i = void 0;
        _len = void 0;
      ...
      processKey38 = function(listId) {
        ...
        return document.getElementById(caId).getElementsByTagName("li")[0].setAttribute("class", "active");
      };
      ...
      setActive = function(liElement) {
        var _i, _len, li, liElements, listId;
        li = void 0;
        liElements = void 0;
        listId = void 0;
        _i = void 0;
      ...
      setupEvents = function(countriesInput, listId) {
        ...
        return document.onclick = function() {
          return hideAutocompleteList(listId);
        };
      };
      ...
      setupCountriesDropdown = function(countriesSelect, listId) {
        ...
        classActive = void 0;
        countries = void 0;
        countriesAutocompleteList = void 0;
        countriesDropdown = void 0;
        countriesInput = void 0;
        countriesInputType = void 0;
        countryCodeValue = void 0;
        i = void 0;
        listItem = void 0;
        name = void 0;
        placeholder = void 0;
        ...
        return self.autocomplete(activeItem);
      };
      ...
      findAndSetupCountries = function() {
        var authyCountries, countries, i, results;
        authyCountries = void 0;
        countries = void 0;
        i = void 0;
      ...
      setCountryField = function() {
        var _i, _len, _results, country, countryCode, defaultListId, field;
        country = void 0;
        countryCode = void 0;
        defaultListId = void 0;
        field = void 0;
        _i = void 0;
        _len = void 0;
        _results = void 0;
...
(function() {
  ...
  window.Authy.UI = function() {
    ...
    processKey40 = function(listId) {
      var activeElement, caId, countriesArr, countriesDropdown, i, j, len, li;
      caId = "countries-autocomplete-" + listId;
      countriesDropdown = document.getElementById(caId);
      countriesArr = countriesDropdown.getElementsByTagName("li");
      i = 0;
      for (j = 0, len = countriesArr.length; j < len; j++) {
        li = countriesArr[j];
        if (li.className === "active" && countriesArr.length > (i + 1)) {
          activeElement = countriesArr[i + 1];
          li.className = "";
    ...
    setActive = function(liElement) {
      var j, len, li, liElements, listId;
      listId = liElement.getAttribute("data-list-id");
      liElements = document.getElementById("countries-autocomplete-" + listId).getElementsByTagName("li");
      for (j = 0, len = liElements.length; j < len; j++) {
        li = liElements[j];
        li.className = "";
      }
      return liElement.className = "active";
    ...
    setCountryField = function() {
      var country, countryCode, defaultListId, field, j, len, results;
      defaultListId = 0;
      field = document.getElementById("authy-countries");
      if (!field) {
        return;
      ...
      if (countryCode !== '') {
        results = [];
        for (j = 0, len = countriesList.length; j < len; j++) {
          country = countriesList[j];
          if (country.code === countryCode) {
            self.autocomplete(buildItem('active', country, defaultListId), true);
            break;
          } else {
